...
/**
 * Junta as duas camadas de fonte de dado pro ativo pedido. Cada leitura é
 * isolada das outras (Promise.allSettled) — um RPC lento na Aave não deve
 * derrubar a resposta inteira quando o comprador já pagou pela chamada. Só
 * lança erro se NENHUMA fonte respondeu, porque aí não há sinal nenhum pra
 * vender.
 */
