...
function signal(overrides: Partial<YieldSignal> = {}): YieldSignal {
  return {
    ...
    gapBps: 50,
    rates: [{ protocol: "compound", apyBps: 500, apyBaseBps: 500, apyRewardBps: 0, rewardBasis: "reported", tvlUsd: 5_000_000, tvlBasis: "total-supplied", weightedApyBps: 495, source: "onchain", asOf: "2026-07-17T12:00:00.000Z" }],
    omittedProtocols: [],
