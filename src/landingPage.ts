...
<h2>One risk in three wrappers (exposure)</h2>
...
<p>The aggregate history is <strong>free and public</strong> at <a href="/persistence">/persistence</a> (machine-readable at <a href="/persistence.json"><code>/persistence.json</code></a>) — evidence behind a paywall proves nothing. What is paid is the state <em>now</em>: which protocol leads, how long it has already led, and the lead duration applied to a MOVE/HOLD call.</p>
