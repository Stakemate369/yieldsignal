...
<title>YieldSignal — real-time USDC lending APY via x402</title>
<style>
...
<body>
<h1>YieldSignal</h1>
<p class="sub">Real-time, risk-weighted USDC lending APY across Aave, Compound, Morpho, Moonwell, Euler and Fluid on Base — paid per call via <a href="https://x402.org">x402</a>.</p>

<p><span class="badge">$0.01/call</span><span class="badge">3 free/day per IP</span><span class="badge">no API key</span></p>

<h2>REST</h2>
<pre>GET https://yieldsignal.vercel.app/signal/usdc-base-yield</pre>
...
<p>Tool <code>get_yield_signal</code> (no arguments), gated per-call via <a href="https://www.npmjs.com/package/@x402/mcp">@x402/mcp</a> — <code>tools/list</code>/<code>initialize</code> stay free, only the tool call is paid.</p>
